    ...
    <div class="container">
        ...
        <div class="col-12 px-0 mb-2">
          <div class="box-right">
            <div class="d-flex pb-2 header">
              <h3>Pacho Design</h3>
              <p class="fw-bold h9">Station MRS, Kotto-Bonamousadai Douala, Cameroon</p>
            </div>
            <div class="bg-blue p-2 msg">
              <p>Whatsapp </p>
              <p class="fw-bold ">+237 123 456 789 / +237
                123456788</p>
            </div>
          </div>
        </div>
      ...
      <div class="col-md-6">
        <div class="client-info">
          ...
          <p class="fw-bold h7">Name</p>
          <p class="textmuted h8">Address</p>
          <p class="textmuted h8 mb-2">+237 phone</p>
        </div>
      </div>
      ...
      <div class="row font">
        <div class="col">Date printed</div>
        <div class="col">Random code</div>
      </div>
    </div>
  </div>
