          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-body">
                ...
                <form method="POST" action="" class="payment-form" wire:submit.prevent="updateOrder">
                  @csrf
                      ...
                      <div class="row">
                        <div class="  col-md-2">
                          <div class="form-group">
                            ...
                            <select class="selectpicker form-control" data-live-search="true"
                              data-live-search-style="begins" title="View Category" placeholder="View Category code">
                              <option value="">View Category code</option>
                        ...
                        <div class="col-md-2">
                          <div class="form-group">
                            ...
                            <input type="number" name="" id="quantity" value="" class="form-control"
                              wire:model="quantity" />
                          </div>
                        </div>
